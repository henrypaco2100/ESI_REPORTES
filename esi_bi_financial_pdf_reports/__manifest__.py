{'name': 'ESI - Odoo All Financial Reports in PDF(BS,P&L,GL,Trial Balance)',
 'version': '13.0.0.3',
 'author': 'ESI - Especialistas en Sistemas Integrados',
 'website': 'https://esibolivia.store',
 'category': 'Contabilidad',
 'summary': 'Este complemento lo ayuda a imprimir todos los informes de contabilidad, es decir, hoja de balance, libro '
            'mayor, balance de comprobación, pérdidas y ganancias',
 'description': ' \n'
                '        Realizar reportes en pdf como el Balance General, Estado de Resultado y Libro Mayor con un '
                'formato modificable\n'
                '    ',
 'depends': ['account'],
 'data': ['views/account_financial_report_line.xml',
