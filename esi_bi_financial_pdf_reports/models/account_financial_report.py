...
class AccountingReportBi(models.TransientModel):
    ...
    def check_report(self):
        ...
        # return self.env.ref('esi_bi_financial_pdf_reports.action_report_balancesheet').report_action(self, data=final_dict)
    ...
    def check_report_estado_resultado(self):
        ...
        # return self.env.ref('esi_bi_financial_pdf_reports.action_report_estado_resultado').report_action(self, data=final_dict)
    ...
    def print_trial_balance(self):
        ...
        return self.env.ref('esi_bi_financial_pdf_reports.action_report_trial_balance').report_action(self, data=final_dict)
    ...
    def print_general_ledger(self):
        ...
        return self.env.ref('esi_bi_financial_pdf_reports.' + self.sd_tipo_reporte_libro_mayor).report_action(self,data=final_dict)
