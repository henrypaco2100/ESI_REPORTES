odoo.define('esi_sd_pos_report_v13.report_excel_button', function (require) {
    'use strict';
    ...
    // únicamente cuando la vista previa fue abierta desde esi_sd_pos_report_v13.
    ReportAction.include({
        start: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                if (isSdPosPreview) {
                    $excelButton.off('click.esi_sd_pos_report_v13');
                    $excelButton.on('click.esi_sd_pos_report_v13', function (ev) {
                        ev.preventDefault();
